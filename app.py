...
MOCHI_DATA = {
    ...
    5: ["austria-hungary", "japan", "neko america", "americat", "Neko Spain", "nordic 5", "nordics", "nordic"],
    5.5: ["2p italy"],
    ...
    10: ["italy", "north italy", "germany", "nyo canada", "spain", "brazil"],
    11: ["france", "romano", "south italy", "nyo poland", "nyo america", "general winter"],
    ...
    30: ["aerican empire", "aerica", "flying mint bunny", "nyo switzerland", "nyo norway", "nyo denmark"],
...
UPDATE_HISTORY = [
    {"date": "2026-8-27", "changes": "Added raritys for new mochis"},
...
def heta_wordle():
    ...
    if 'just_won' not in st.session_state:
        st.session_state.just_won = False
    if 'win_guesses' not in st.session_state:
        st.session_state.win_guesses = 0
